...
if __name__ == '__main__':
    ...
    LRPORT = 13434  # 端口号
    MAC = [0x62, 0x01, 0x94, 0x02, 0x2D, 0X6D, 0X00, 0x00]  #00:00:60:01:94:02:2D:6D

    LRAddress = (LRHOST, LRPORT)

    a = LED(MAC, LRAddress)
    # lc = LED(MAC, LRAddress)
    str1 = a.BFPacket(brig) #0~100
    color = a.RGBWFPacket(255,0,255,0)


    a.Control(str1)
    a.Control(color)

    # lc.Control(lc.BFPacket(80))