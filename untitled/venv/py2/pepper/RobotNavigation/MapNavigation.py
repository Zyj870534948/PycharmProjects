...
s = '{' + s + '}'
data = json.loads(s)
print type(data),data["nvwashiyanshi"]

navigation.loadExploration(data["nvwashiyanshi"])    #/home/nao/.local/share/Explorer/2014-04-04T012831.156Z.explo    #/home/nao/.local/share/Explorer/2019-02-27T071633.300Z.explo
